...
def get_real_healthcare_data():
    ...
    hospital_data = pd.DataFrame({
        ...
        'beds_per_100k': [
            ...
            240, 280, 200, 240, 240, 280, 240, 200, 200, 240, 200, 200, 280, 240, 320
        ],
        'doctors_per_100k': [
            ...
            200, 240, 280, 240, 280, 200, 220, 200, 200, 320, 280, 280, 200, 240, 240
        ],
        'avg_rating': [
            ...
            3.9, 4.0, 3.8, 3.9, 4.1, 3.8, 4.2, 3.7, 3.8, 3.9, 4.0, 4.3, 4.1, 4.2, 3.7, 4.0, 4.1
        ]
    })
    
    # Real cost data
    cost_data = pd.DataFrame({
        'state': hospital_data['state'].tolist(),
        'avg_premium': [
            ...
            380, 400, 460, 440, 520, 400, 380, 390, 350, 480, 450, 430, 400, 440, 420
        ],
        'avg_deductible': [
            ...
            1800, 2500, 2400, 2300, 2100, 2300, 2200
        ],
        'healthcare_spending_per_capita': [
            ...
            9500, 8500, 9000, 8000, 12000, 11000, 10500, 9000, 10000, 9500
        ],
        'uninsured_rate': [
